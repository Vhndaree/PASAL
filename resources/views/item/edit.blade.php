        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">{{ __('Item entry') }}</div>
                    <div class="card-body"> 
                        <form method="POST" action="{{action('ItemController@update',$id)}}" aria-label="{{ __('Item entered') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">                                
                                    <select id='name' class='form-control' name='unit'>
                                        <option value='kilogram' @if($new->unit=="kilogram") selected @endif>Kilogram</option>
                                        <option value='pieces' @if($new->unit=="pieces") selected @endif>Pieces</option>
                                    </select>                               
                                </div>
                            </div>
