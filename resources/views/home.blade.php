...
<div class="col-md-9 ml-sm-auto col-lg-10 px-4">
    ...
    <div class="page-body">
        <div class="row">
          <div class="col-sm-4">
            <a href="sales/create"><div class="tile purple">
              Sales                   
            </div>
          </div></a>
          <div class="col-sm-4">
            <a href="purchase/create"><div class="tile red">
             purchase
            </div></a>
          </div>
          <div class="col-sm-4">
              <a href="item/create"><div class="tile orange">
              Items 
            </div></a>
          </div>          
          <div class="col-sm-4">
            <a href="vendor/create"><div class="tile green">
                vendors
            </div></a>
          </div>                  
        </div>
